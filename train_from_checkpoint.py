...
CHECKPOINT_PATH = r"weights/epoch_120.pth"
...
if __name__ == '__main__':  # Prevent recursive subprocess creation
    ...
    scheduler = lrs.LambdaLR(optimizer, lambda e: lr_lambda(e + CHECKPOINT_EPOCH))
    ...
    log_file_path = "log_c.txt"
    weight_dir = "weights_c"
