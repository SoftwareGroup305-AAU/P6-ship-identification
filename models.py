...
class Head(nn.Module):
    def __init__(self, num_classes, num_predictors):
        ...
        self.objectness = nn.Conv2d(128, 1*num_predictors, 1)
        self.localization = nn.Conv2d(128, 4*num_predictors, 1)
    ...
    def forward(self, x):
        ...
        B, _, H, W = loc.shape
        localization_output = F.sigmoid(loc).permute(0, 2, 3, 1).contiguous()
        localization_output = localization_output.view(B, H, W, self.B, 4)
...
class YOLO(nn.Module):
    def __init__(self, num_classes, num_predictors):
        ...
        self.head = Head(num_classes, num_predictors)
